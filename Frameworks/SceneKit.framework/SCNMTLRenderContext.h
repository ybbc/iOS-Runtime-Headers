...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
    ...
    int  _profile;
    struct SCNMTLRenderCommandEncoder { bool x1; unsigned long long x2; unsigned long long x3; unsigned long long x4; unsigned long long x5; bool x6; bool x7; bool x8; bool x9; unsigned int x10; unsigned int x11; bool x12; bool x13; struct { id x_14_1_1; unsigned long long x_14_1_2; } x14[31]; id x15[31]; id x16[16]; struct { id x_17_1_1; unsigned long long x_17_1_2; } x17[31]; id x18[31]; id x19[16]; id x20; id x21; id x22; struct SCNMTLBufferPool {} *x23; unsigned int x24; unsigned int x25; } * _renderEncoder;
    struct { 
...
@property (nonatomic, readonly) struct SCNMTLComputeCommandEncoder { id x1[31]; unsigned long long x2[31]; id x3[31]; id x4[16]; unsigned int x5; id x6; id x7; id x8; struct SCNMTLBufferPool {} *x9; unsigned int x10; unsigned int x11; }*resourceComputeEncoder;
...
- (struct SCNMTLComputeCommandEncoder { id x1[31]; unsigned long long x2[31]; id x3[31]; id x4[16]; unsigned int x5; id x6; id x7; id x8; struct SCNMTLBufferPool {} *x9; unsigned int x10; unsigned int x11; }*)resourceComputeEncoder;
- (id)resourceGroup;
- (id)resourceManager;
- (id)resourceQueue;
- (bool)reverseZ;
