...
- (void)fetchParameterizedAttribute:(void *)arg1 forElement:(void *)arg2 parameter:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 10: NSString *, XCAccessibilityElement *, id, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, NSError *, void*
