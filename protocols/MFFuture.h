...
- (bool)isCancelled;
- (bool)isFinished;
- (<MFFuture> *)map:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, id, id /* block */, id, void*
...
- (void)onScheduler:(void *)arg1 addSuccessBlock:(void *)arg2; // needs 2 arg types, found 7: <MFScheduler> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, id, void*
- (<MFFuture> *)onScheduler:(void *)arg1 map:(void *)arg2; // needs 2 arg types, found 7: <MFScheduler> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, id, id /* block */, id, void*
...
- (<MFFuture> *)onScheduler:(void *)arg1 then:(void *)arg2; // needs 2 arg types, found 7: <MFScheduler> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, <MFFuture> *, id /* block */, id, void*
...
- (<MFFuture> *)then:(void *)arg1; // needs 1 arg types, found 6: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, <MFFuture> *, id /* block */, id, void*
- (bool)tryCancel;
