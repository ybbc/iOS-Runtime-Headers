...
+ (void)setSlotResolutionPredictionItemForTopUpcomingMediaActionContainer:(id)arg1 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[259]; float x4; }*)arg2 appActionLogProbability:(double)arg3;
+ (id)sharedInstance;
+ (id)yearMonthDayComponentsForDate:(id)arg1;

- (void).cxx_destruct;
- (id)actionPredictionsForStatistics:(id)arg1;
- (id)actionPredictionsForStatistics:(id)arg1 appActionPredictionItem:(const struct ATXPredictionItem { id x1; unsigned long long x2; float x3[259]; float x4; }*)arg2 appActionLogProbability:(double)arg3 scoreLogger:(id)arg4;
