...
- (id)initWithScoredAction:(struct ATXScoredPrediction { Class x1; }*)arg1 slotSet:(id)arg2 minimalSlotResolutionParameters:(id)arg3 score:(float)arg4 actionKey:(id)arg5 predictionItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[259]; float x4; })arg6;
- (void)initializeScoredActionAndSlotSet;
- (bool)isEqual:(id)arg1;
- (bool)isEqualToActionPredictionContainer:(id)arg1;
- (struct ATXPredictionItem { id x1; unsigned long long x2; float x3[259]; float x4; })predictionItem;
- (float)score;
- (struct ATXScoredPrediction { Class x1; }*)scoredAction;
- (void)setPredictionItem:(struct ATXPredictionItem { id x1; unsigned long long x2; float x3[259]; float x4; })arg1;
