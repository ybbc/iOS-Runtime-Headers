...
- (void)captureOutput:(struct AVCaptureOutput { Class x1; id x2; }*)arg1 didOutputSampleBuffer:(struct opaqueCMSampleBuffer { }*)arg2 fromConnection:(struct AVCaptureConnection { Class x1; id x2; }*)arg3;
- (void)disconnect;
