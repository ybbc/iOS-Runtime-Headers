...
- (void)outputMediaDataWillChange:(struct AVPlayerItemVideoOutput { Class x1; id x2; id x3; }*)arg1;
- (void)outputSequenceWasFlushed:(struct AVPlayerItemVideoOutput { Class x1; id x2; id x3; }*)arg1;
